...
| 09-26 10:35 | ses_pixel (esta sesion) | `local-coding/docs/KERNEL_SOTA_PLAN_2026-09-26.md`, `BRIEFS/06_*`, `BRIEFS/07_*`, `local-coding/data/np_curve_20260926.json` | 09-26 18:00 | plan SOTA kernel (vecq PTQ1_0 roto = gap real) + curva de concurrencia medida; sin builds ni GPU (tope 15% CPU del usuario) | ACTIVO |
